...
import (
	...
	"github.com/searKing/sole/cmd/sole/app/serve"
	versioncmd "github.com/searKing/sole/cmd/sole/app/version"
	"github.com/spf13/cobra"
)

func init() {
	version.ServiceName = "sole"
	version.ServiceDescription = "sole is a cloud native high throughput service manager server, allowing you to manage all services."
