...
func NewServiceRegistry(consulAddr string, serviceName string, serviceAddress string) (*ServiceRegistryServer, error) {
...
func (srv *ServiceRegistryServer) Register() error {
	...
	checkUrl := fmt.Sprintf("http://%v:%v/api/transfer_proxy/v1/health", srv.Ip, srv.Port)
