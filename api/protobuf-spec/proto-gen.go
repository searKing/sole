...
//go:generate bash scripts/proto-gen.sh . -I . -I ../../../../../ -I ../../.third_party/github.com/googleapis/googleapis/ --with_go_tag --with_go_grpc --with_go_grpc_gateway --with_go_grpc_openapiv2
//go:generate bash scripts/swagger-mix.sh .
//go:generate bash scripts/swagger-deploy.sh . "../../pkg/web/webapp/static/swagger"
//go:generate bash scripts/swagger-deploy.sh . "../../api/openapi-spec/sole"
