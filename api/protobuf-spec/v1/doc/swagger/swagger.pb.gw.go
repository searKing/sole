...
var (
	pattern_SwaggerService_Json_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"doc", "swagger", "swagger.json"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SwaggerService_Yaml_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"doc", "swagger", "swagger.yaml"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SwaggerService_UI_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"doc", "swagger", "swagger-ui"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SwaggerService_UI_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"doc", "swagger", "swagger-ui", "index.html"}, "", runtime.AssumeColonVerbOpt(true)))
)
